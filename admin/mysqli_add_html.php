...
<div class="box3">
    ...
    <h2>&nbsp;&nbsp;&nbsp;管理员菜单</h2>
     &nbsp;&nbsp;学生管理
    <ul type="disc">
       <li class="zi"><a href="./mysqli_empAdd.php" STYLE='text-decoration:none;COLOR:black'>学生信息登记</a></li>
...
<div class="box">
	...
	<table class="profile-table">
		...
		<tr><th>政治面貌：</th><td><input type="text" name="policy" ></td></tr>
