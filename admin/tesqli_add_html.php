...
<div class="box3">
    ...
    &nbsp;&nbsp;教师管理
    <ul type="disc">
       <li class="zi"><a href="./tesqli_empAdd.php" STYLE='text-decoration:none;COLOR:black'>教师信息登记</a></li>
...
<div class="box">
	<h1>添加教师</h1>
	<form method="post" action="./tesqli_empAdd.php">
	<table class="profile-table">
	    <tr><th>教师编号：</th><td><input type="text" name="id" /></td></tr>
	    <tr><th>登录密码：</th><td><input type="text" name="password" /></td></tr>
		<tr><th>姓名：</th><td><input type="text" name="name" /></td></tr>
		<tr><th>性别：</th><td><input type="text" name="gander" /></td></tr>
		<tr><th>职称：</th><td><input type="text" name="zhicheng" ></td></tr>
