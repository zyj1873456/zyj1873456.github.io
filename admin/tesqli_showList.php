...
include './public_sqli_fun_te.php';
$sql = 'select * from emp_info';
$where = '';
if(isset($_GET['keyword'])){
	$keyword =   $_GET['keyword'];
	$keyword = safeHandle($link,$keyword);
	$where = "where name like '%$keyword%' or id like '%$keyword%' or zhicheng like '%$keyword%'or gander like '%$keyword%'";
}
