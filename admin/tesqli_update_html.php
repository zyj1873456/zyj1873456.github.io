...
<div class="box3">
    ...
    <ul type="disc">
       ...
       <li class="zi"><a href="./tesqli_showlist.php" STYLE='text-decoration:none;COLOR:black'>教师信息管理</li>
     </ul>
     &nbsp;&nbsp;系统管理
     <ul type="disc">
...
<div class="box">
  ...
  <table class-"profile-table">
    ...
    <tr><th>职称:</th>
    <td><input type= "text" name= "zhicheng" value="<?php echo $emp_info['zhicheng']; ?>"></td></tr>
