...
.zi{
    ...
    <table width=800px height=50px bgcolor="#0072E3">
      <tr><th><h2>系统管理</h2></th></tr>
		...
		<div class="body body-s" style="overflow:scroll; height:235px;">		
				...
				<fieldset>
			     <section>
						<label class="input">
							...
							<input type="text" id="userid" name="userid" placeholder="学号">
						</label>
					</section>	
		...
		$("#btn").click(function(){
			...
			if(id==""){
             ...
             $.post("change_check.php",{id:id,password:password,password2:password2},function(data){
             	 
             	   if(data==11){
             	   	  layer.msg('该学号不存在!',{time:2000});
