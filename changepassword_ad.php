...
.zi{
    ...
    <div class="box1">
     ...
     &nbsp;&nbsp;学生管理
    <ul type="disc">
       <li><a href="../admin/mysqli_empAdd.php" STYLE='text-decoration:none;COLOR:black'>学生信息登记</a></li>
       <li><a href="../admin/mysqli_showlist.php" STYLE='text-decoration:none;COLOR:black'>学生信息管理</a></li>
    </ul>
    &nbsp;&nbsp;教师管理
    <ul type="disc">
       <li><a href="../admin/tesqli_empAdd.php" STYLE='text-decoration:none;COLOR:black'>教师信息登记</a></li>
       <li><a href="../admin/tesqli_showlist.php" STYLE='text-decoration:none;COLOR:black'>教师信息管理</a></li>
     </ul>
     &nbsp;&nbsp;系统管理
     <ul type="disc">
       <li class="zi"><a href="../upload/changepassword_ad.php" STYLE='text-decoration:none;COLOR:black'>修改密码</a></li>
    ...
    <table width=800px height=50px bgcolor="#0072E3">
      <tr><th><h2>系统管理</h2></th></tr>
		...
		<div class="body body-s" style="overflow:scroll; height:245px;">		
				...
				<fieldset>
			     <section>
						<label class="input">
							...
							<input type="text" id="userid" name="userid" placeholder="管理员编号">
						</label>
					</section>	
		...
		$("#btn").click(function(){
			...
			if(id==""){
             ...
             $.post("change_check_ad.php",{id:id,password:password,password2:password2},function(data){
             	 
             	   if(data==11){
             	   	  layer.msg('该编号不存在!',{time:2000});
             	   	  setTimeout("window.location.href='changepassword_ad.php'",2000);
             	   }else if(data==14){
