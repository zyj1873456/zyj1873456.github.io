...
function del(){ 
 ...
 <div class="box3">
    ...
    <ul type="disc">
       ...
       <li class="zi"><a href="./mysqli_showlist.php" STYLE='text-decoration:none;COLOR:black'>课程管理</a></li>
     </ul>
     &nbsp;&nbsp;作业管理
     <ul type="disc">
...
<?php if(!empty($emp_info)) { ?>
   ...
   <tr>
      ...
      <td><?php echo $row['xueshi'];?></td>
      <td><?php echo $row['xuefen'];?></td>
      <td>
		  <div align="center">
			<span>
				<img src="images/edt.gif" width="16" height="16" />
				<a href="<?php echo './mysqli_empUpdate.php?id='.$row['id'] ?>" 
   ...
   <?php  } ?>
		...
		<div class="search"><a href="./mysqli_empAdd.php">添加课程</a></div>
</div>
 </body>
</html>