...
function del(){ 
 ...
 <div class="box3">
    ...
    <ul type="disc">
     ...
     &nbsp;&nbsp;作业管理
     <ul type="disc">
       <li><a href="../phps/upload_te.php" STYLE='text-decoration:none;COLOR:black'>布置作业</li>
       <li><a href="../upload/result.php" STYLE='text-decoration:none;COLOR:black'>作业管理</a></li>
       </ul>
       &nbsp;&nbsp;成绩管理
     <ul type="disc">
       <li class="zi"><a href="./mysqli_showList_score.php" STYLE='text-decoration:none;COLOR:black'>成绩管理</a></li>
       <li><a href="./mysqli_empadd_score.php" STYLE='text-decoration:none;COLOR:black'>添加成绩</a></li>
       </ul>
     &nbsp;&nbsp;系统管理
     <ul type="disc">
    ...
    <table width=800px height=50px bgcolor="#0072E3">
      <tr><th><h2>成绩管理</h2></th></tr>
    </table>
    <div class="box3" style="overflow:scroll; height:370px; width: 780px;">
    <form action="./mysqli_showlist_score.php" method="GET">
	  <form action="./mysqli_showList_score.php" method="post">
		<div class="box">
...
<?php if(!empty($emp_info)) { ?>
      ...
      <td>
		  <div align="center">
			<span>
				...
				<a href="<?php echo './mysqli_empUpdate_score.php?sno='.$row['sno'] ?>" 
				onclick="javascript:return edit()">编辑</a>&nbsp; &nbsp;
				<a href="<?php echo './mysqli_empDel_score.php?sno='.$row['sno'] ?>" 
   ...
   <?php  } ?>
		...
		<div class="search"><a href="./mysqli_empAdd_score.php">添加学生成绩</a></div>
</div>
 </body>
</html>