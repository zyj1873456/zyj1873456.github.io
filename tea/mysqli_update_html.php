...
<div class="box">
  ...
  <table class-"profile-table">
    <tr><th>课程编号: </th>
    <td><input type-"text" name="id" value="<?php echo $emp_info['id']; ?>"/></td></tr>
    <tr><th>课程名称: </th>
    <td><input type-"text" name="name" value="<?php echo $emp_info['name']; ?>"/></td></tr>
    <tr><th>课程学时: </th>
    <td><input type-"text" name="xueshi" value="<?php echo $emp_info['xueshi']; ?>"/></td></tr>
    <tr><th>课程学分 </th>
    <td><input type="text" name="xuefen" value="<?php echo $emp_info['xuefen']; ?>"/></td></tr>
